...
class ApiClient {
  ...
  // profile — now accepts budget & dietary_restrictions
  async createProfile(data) {
    return this.request('/profile', { method: 'POST', body: data })
  }
  async fetchProfile() {
    return this.request('/profile')
  }
  async generateMealPlan(id) {
    return this.request(`/generate_plan/${id}`)
  }
